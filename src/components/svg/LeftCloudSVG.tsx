...
export default function LeftCloudSVG() {
  return (
    <motion.svg
      viewBox="0 0 50.23 28.18"
      xmlns="http://www.w3.org/2000/svg"
      data-name="Lager 1"
      className="w-64 top-[-45%] absolute md:w-80 md:left-[calc(50%-320px)] lg:w-96"
...
// absolute top-[-65%] right-[5%] md:w-[40vw] md:right-[18%] md:top-[-50%] xl:right-[30%] xl:w-[30vh]
